...
export function enrichToolArgs(tool, args, cwd) {
...
function enrichEditToolArgs(base, cwd) {
...
function readToolFile(filePath, cwd) {
    if (!filePath)
        return null;
...
function buildEditHunk(fileText, startOffset, oldText, newText) {
    const context = 4;
...
//# sourceMappingURL=edit_hunks.js.map