 ...
 * exists for it).
 */
type SendUserMessageOptions = NonNullable<Parameters<ExtensionAPI["sendUserMessage"]>[1]>;
...
export declare function wakeAgent(pi: ExtensionAPI | null, content: Parameters<ExtensionAPI["sendUserMessage"]>[0], label: string, steeringBehavior?: SendUserMessageOptions["deliverAs"], notify?: (message: string, level: "info" | "warning" | "error") => void): WakeAgentResult;
export {};
